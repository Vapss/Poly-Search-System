...
<body>
 ...
 <html>
    	...
    	<header>
		<h1 id="titulo">  BUSCAR DISCAPACIDAD</h1> </header>
 		<div align="center">
...
$bd_bdname = "pss";
$bd_tabla = "DISCAPACIDAD"; // Tabla donde se harán las búsquedas
...
<p><form name="buscar" method="post" action="../BUSCAR/buscar_discapacidad.php"><br>
Buscar en:
<select name="campo">
