...
<body>
 ...
 <html>
    	...
    	<header>
		<h1 id="titulo">  BUSCAR EMPLEADO </h1> </header>
 		<div align="center">
...
$bd_bdname = "pss";
$bd_tabla = "EMPLEADO"; // Tabla donde se har�n las b�squedas
...
<p><form name="buscar" method="post" action="../BUSCAR/buscar_empleado.php"><br>
Buscar en:
<select name="campo">
