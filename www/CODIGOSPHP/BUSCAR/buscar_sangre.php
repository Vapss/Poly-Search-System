...
<body>
 ...
 <html>
    	...
    	<header>
		<h1 id="titulo">  BUSCAR TIPO DE SANGRE </h1> </header>
 		<div align="center">
...
$bd_bdname = "pss";
$bd_tabla = "SANGRE"; // Tabla donde se harán las búsquedas
...
<p><form name="buscar" method="post" action="../BUSCAR/buscar_sangre.php"><br>
Buscar en:
<select name="campo">
