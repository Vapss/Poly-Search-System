...
<body>
 ...
 <html>
    	...
    	<header>
		<h1 id="titulo">  BUSCAR TELEFONO </h1> </header>
 		<div align="center">
...
$bd_bdname = "pss";
$bd_tabla = "TELEFONO"; // Tabla donde se harán las búsquedas
...
<p><form name="buscar" method="post" action="../BUSCAR/buscar_telefono.php"><br>
Buscar en:
<select name="campo">
