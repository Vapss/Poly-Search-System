...
<body>
 ...
 <html>
    	...
    	<header>
		<h1 id="titulo">  BUSCAR ENFERMEDAD DE ALUMNO </h1> </header>
 		<div align="center">
...
$bd_bdname = "pss";
$bd_tabla = "ALUENF"; // Tabla donde se harán las búsquedas
...
<p><form name="buscar" method="post" action="../BUSCAR/buscar_aluenf.php"><br>
Buscar en:
<select name="campo">
...
$query = "SELECT MATRICULA3,APE_P,APE_M,NOMBRE,NOM_ENF FROM ALUENF inner join ALUMNO on ALUENF.MATRICULA3=ALUMNO.MATRICULA inner join ENFERMEDAD on ALUENF.ID_ENF1=ENFERMEDAD.ID_ENF WHERE `{$_POST['campo']}` LIKE '%{$_POST['palabra']}%'";
