...
<body>
 ...
 <html>
    	...
    	<header>
		<h1 id="titulo">  BUSCAR TELEFONOS DE ALUMNO </h1> </header>
 		<div align="center">
...
$bd_bdname = "pss";
$bd_tabla = "ALUTEL"; // Tabla donde se harán las búsquedas
...
<p><form name="buscar" method="post" action="../BUSCAR/buscar_alutel.php"><br>
Buscar en:
<select name="campo">
...
$query = "SELECT MATRICULA2,APE_P,APE_M,NOMBRE,TIPO_TELEFONO,FON FROM ALUTEL INNER JOIN ALUMNO ON ALUTEL.MATRICULA2=ALUMNO.MATRICULA INNER JOIN TELEFONO ON ALUTEL.ID_TELEFONO2=TELEFONO.ID_TELEFONO WHERE `{$_POST['campo']}` LIKE '%{$_POST['palabra']}%'";
