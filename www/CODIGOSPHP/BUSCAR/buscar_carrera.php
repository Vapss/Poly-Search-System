...
<body>
 ...
 <html>
    	...
    	<header>
		<h1 id="titulo">  BUSCAR CARRERA </h1> </header>
 		<div align="center">
...
$bd_bdname = "pss";
$bd_tabla = "CARRERA"; // Tabla donde se harán las búsquedas
...
<p><form name="buscar" method="post" action="../BUSCAR/buscar_carrera.php"><br>
Buscar en:
<select name="campo">
