...
<body>
 ...
 <html>
    	...
    	<header>
		<h1 id="titulo">  BUSCAR ESTATUS </h1> </header>
 		<div align="center">
...
$bd_bdname = "pss";
$bd_tabla = "ESTATUS"; // Tabla donde se harán las búsquedas
...
<p><form name="buscar" method="post" action="../BUSCAR/buscar_estatus.php"><br>
Buscar en:
<select name="campo">
