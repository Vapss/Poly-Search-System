...
<body>
 ...
 <html>
    	...
    	<header>
		<h1 id="titulo">  BUSCAR ACTIVIDADES EXT. DE ALUMNO </h1> </header>
 		<div align="center">
...
$bd_bdname = "pss";
$bd_tabla = "ALUMEXT"; // Tabla donde se harán las búsquedas
...
<p><form name="buscar" method="post" action="../BUSCAR/buscar_alumext.php"><br>
Buscar en:
<select name="campo">
...
$query = "SELECT MATRICULA1,APE_P,APE_M,NOMBRE,NOM_ACTEXT FROM ALUMEXT INNER JOIN ALUMNO ON ALUMEXT.MATRICULA1=ALUMNO.MATRICULA INNER JOIN ACTEXT ON ALUMEXT.ID_ACTEXT2=ACTEXT.ID_ACTEXT WHERE `{$_POST['campo']}` LIKE '%{$_POST['palabra']}%'";
