...
<body>
 ...
 <html>
    	...
    	<header>
		<h1 id="titulo">  BUSCAR ALUMNO </h1> </header>
 		<div align="center">
...
$bd_bdname = "pss";
$bd_tabla = "ALUMNO"; // Tabla donde se har�n las b�squedas
...
<p><form name="buscar" method="post" action="../BUSCAR/buscar_alumno.php"><br>
Buscar en:
<select name="campo">
...
$query = "SELECT MATRICULA,NOMBRE,APE_P,APE_M,FOTO,GRUPO,GENERO,CURP,CORREO,PESO, ALTURA,TIP_SAN, NOM_TURNO,NOM_CARRERA,NOM_ESTATUS FROM ALUMNO inner join SANGRE on ALUMNO.ID_SAN1=SANGRE.ID_SAN inner join  TURNO on ALUMNO.ID_TURNO1=TURNO.ID_TURNO inner join CARRERA on ALUMNO.ID_CARRERA1=CARRERA.ID_CARRERA inner join ESTATUS ON ALUMNO.ID_ESTATUS1=ESTATUS.ID_ESTATUS WHERE `{$_POST['campo']}` LIKE '%{$_POST['palabra']}%'";
...
if($nombre_campo=='FOTO'){
    echo "<b>".$nombre_campo."</b> : <img src=".$valor_campo." width=100 height=150>"."<br>";   
}else
