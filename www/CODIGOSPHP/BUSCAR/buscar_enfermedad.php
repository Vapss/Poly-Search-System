...
<body>
 ...
 <html>
    	...
    	<header>
		<h1 id="titulo">  BUSCAR ENFERMEDAD</h1> </header>
 		<div align="center">
...
$bd_bdname = "pss";
$bd_tabla = "ENFERMEDAD"; // Tabla donde se harán las búsquedas
...
<p><form name="buscar" method="post" action="../BUSCAR/buscar_enfermedad.php"><br>
Buscar en:
<select name="campo">
