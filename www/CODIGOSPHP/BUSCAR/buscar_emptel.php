...
<body>
 ...
 <html>
    	...
    	<header>
		<h1 id="titulo">  BUSCAR TELEFONO DE EMPLEADO </h1> </header>
 		<div align="center">
...
$bd_bdname = "pss";
$bd_tabla = "EMPTEL"; // Tabla donde se harán las búsquedas
...
<p><form name="buscar" method="post" action="../BUSCAR/buscar_emptel.php"><br>
Buscar en:
<select name="campo">
...
$query = "SELECT NUM_EMP2,APE_PE,APE_ME,NOM_E,TIPO_TELEFONO,FON FROM EMPTEL INNER JOIN EMPLEADO ON EMPTEL.NUM_EMP2=EMPLEADO.NUM_EMP INNER JOIN TELEFONO ON EMPTEL.ID_TELEFONO1=TELEFONO.ID_TELEFONO WHERE `{$_POST['campo']}` LIKE '%{$_POST['palabra']}%'";
