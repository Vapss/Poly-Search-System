...
<body>
 ...
 <html>
    	...
    	<header>
		<h1 id="titulo">  BUSCAR DISCAPACIDAD DE ALUMNO </h1> </header>
 		<div align="center">
...
$bd_bdname = "pss";
$bd_tabla = "ALUDIS"; // Tabla donde se harán las búsquedas
...
<p><form name="buscar" method="post" action="../BUSCAR/buscar_aludis.php"><br>
Buscar en:
<select name="campo">
...
$query = "SELECT MATRICULA4,APE_P,APE_M,NOMBRE,NOM_DIS FROM ALUDIS inner join ALUMNO on ALUDIS.MATRICULA4=ALUMNO.MATRICULA inner join DISCAPACIDAD on ALUDIS.ID_DIS1=DISCAPACIDAD.ID_DIS WHERE `{$_POST['campo']}` LIKE '%{$_POST['palabra']}%'";
