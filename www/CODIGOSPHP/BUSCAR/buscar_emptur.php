...
<body>
 ...
 <html>
    	...
    	<header>
		<h1 id="titulo">  BUSCAR TURNOS DE EMPLEADO </h1> </header>
 		<div align="center">
...
$bd_bdname = "pss";
$bd_tabla = "EMPTUR"; // Tabla donde se harán las búsquedas
...
<p><form name="buscar" method="post" action="../BUSCAR/buscar_emptur.php"><br>
Buscar en:
<select name="campo">
...
$query = "SELECT NUM_EMP1,APE_PE,APE_ME,NOM_E,NOM_TURNO,ESTATUS FROM EMPTUR INNER JOIN EMPLEADO ON EMPTUR.NUM_EMP1=EMPLEADO.NUM_EMP INNER JOIN TURNO ON EMPTUR.ID_TURNO3=TURNO.ID_TURNO WHERE `{$_POST['campo']}` LIKE '%{$_POST['palabra']}%'";
